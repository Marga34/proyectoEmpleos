...
new Oferta ('Aratech','http://www.ara-tech.es/wp-content/uploads/2015/05/logo_aratech_PT.jpg', 'Programador junior','11/05/2017', 'Tres Cantos (Madrid)', '18.000 - 24.000 br/año', 'Menos de 3 años', 'Indefinido', 'JavaScript / JQuery / HTML5 / CSS3','Somos una compañía tecnológica de ámbito internacional. Buscamos profesionales con perfil de Programador y Analista Programador en tecnologías Java/J2EE...' ,'Somos una compañía tecnológica de ámbito internacional. Buscamos profesionales con perfil de Programador y Analista Programador en tecnologías Java/J2EE para incorporarse en varios de nuestros clientes más importantes que se encuentran en pleno proceso de Transformación Digital.', '8', 'Jornada completa', 'Ingenieria Técnica', 'Persona dinámica'),
...
new Oferta ('Microsoft','http://diylogodesigns.com/blog/wp-content/uploads/2016/04/Microsoft-Logo-PNG.png', 'Programador senior','25/04/2017', 'Mirasierra (Madrid)', '24.000 - 30.000 br/año', 'Menos de 3 años', 'Indefinido', 'JavaScript / JQuery / HTML5 / CSS3 / HTML5 / Bootstrap','Actualmente buscamos un MAQUETADOR WEB para incorporarse en puesto estable a cliente IT con oficinas en la zona de Mirasierra (Madrid).' ,'Actualmente buscamos un MAQUETADOR WEB para incorporarse en puesto estable a cliente IT con oficinas en la zona de Mirasierra (Madrid).', '3', 'Jornada completa', 'Formación Profesional Grado Medio', 'Detalles en entrevista laboral'),
new Oferta ('Everis','https://media.infojobs.net/corp/everis2_logo.gif', 'Programador junior','25/04/2017', 'Mirasierra (Madrid)', '18.000 - 24.000 br/año', 'Menos de 5 años', 'Indefinido', 'JavaScript / JQuery / HTML5 / CSS3 / Bootstrap / Node Js','Estamos buscando a los mejores profesionales para incorporarse a tiempo completo a nuestra línea de servicios de Arquitectura, dentro del equipo de expertos en tecnología Web Single Page Interface...' ,'Estamos buscando a los mejores profesionales para incorporarse a tiempo completo a nuestra línea de servicios de Arquitectura, dentro del equipo de expertos en tecnología Web Single Page Interface como (AngularJS, React,...), con capacidad full-stack para definir e implementar también la parte correspondiente del Back (API Management, NodeJS, Spring Framework...).', '1', 'Jornada completa', 'Ingenieria', 'Detalles en entrevista personal')];
